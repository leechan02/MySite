...
export default function Highlights() {
  return (
    <div className='bg-foreground/5 shadow border-2 border-foreground/10 rounded-2xl sm:rounded-[40px] backdrop-blur-[15px] p-4 sm:p-6 lg:p-8 w-full flex flex-col justify-center items-center gap-4 sm:gap-6 font-mono'>
      <div className='text-xs sm:text-sm opacity-50 font-bold'>HIGHLIGHTS</div>
      ...
      <div className='w-full max-w-4xl p-4 sm:p-8 lg:p-16 rounded-2xl sm:rounded-[40px] bg-color2 bg-opacity-20'>
      ...
      <div className='w-full rounded-2xl sm:rounded-[40px] bg-color2 bg-opacity-20 overflow-hidden'>
        <Image
