    ...
    <div className='flex flex-col justify-center items-center gap-16 w-[300px] lg:w-[400px]'>
      <div className='flex flex-col justify-center items-start gap-4'>
        ...
        <div className='text-xs font-mono text-foreground opacity-50'>
          In 2022, I started my journey into development without knowing how to
          code or use a terminal. As I grew more curious about the world, I
          recognized many inefficiencies around me and realized the importance
          of problem-solving.
        </div>
        <div className='text-xs font-mono text-foreground opacity-50'>
          This led me to 42 Seoul, where I immersed myself in computer science
          fundamentals such as operating systems, data structures, and networks.
          Currently, I am focusing on frontend development to address real-world
          challenges.
        </div>
      </div>
      ...
      <div className='flex flex-col justify-center items-start gap-4'>
        ...
        <div className='text-xs font-mono text-foreground opacity-50'>
          ...
          development is rarely a solo effort. Starting from scratch has taught
          me how to explain concepts clearly and in a way that others can easily
          understand.
        </div>
      </div>
      <div className='relative w-[300px] lg:w-[400px] h-[400px] border-10 border-color1 rounded-[40px] overflow-hidden'>
