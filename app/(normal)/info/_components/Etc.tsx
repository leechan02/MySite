  ...
  return (
    <div className='flex flex-col justify-center items-start sm:w-[640px] lg:w-[900px] gap-4'>
      ...
      <div className='flex justify-start items-center gap-2 font-mono text-foreground'>
        <div className='font-sm font-bold'>OPIc AL</div>
        <div className='font-xs font-bold opacity-50'>2024.6.7</div>
      </div>
      <div className='flex justify-start items-center gap-2 font-mono text-foreground'>
        <div className='font-sm font-bold'>
          Craftsman Information Processing
        </div>
        <div className='font-xs font-bold opacity-50'>2024.7.3</div>
      </div>
    </div>
  );
}
