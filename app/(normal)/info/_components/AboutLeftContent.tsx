    ...
    <div>
      <div className='flex flex-col justify-center items-center gap-16'>
        ...
        <div className='flex flex-col justify-center items-start gap-4'>
          ...
          <div className='text-xs font-mono text-foreground opacity-50'>
            As a developer, I value communication skills, <br /> especially
            since development is rarely a solo effort. <br /> Starting from
            scratch has taught me how to explain <br /> concepts clearly and in
