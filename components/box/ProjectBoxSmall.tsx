...
export default function ProjectBoxSmall({title, description, date, video, bgColor}: ProjectBoxSmallProps) {
  ...
  return (
    ...
    >
      <div className='w-[280px] h-[320px] rounded-2xl drop-shadow-3xl overflow-hidden relative z-10'>
        <video
