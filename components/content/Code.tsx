...
export default function Code({ code, language, codeEx, project }: CodeProps) {
  ...
  return (
    <div className='flex flex-col justify-center items-center font-mono text-foreground w-full gap-4'>
      <div className='bg-primary shadow border-2 border-foreground/10 rounded-2xl backdrop-blur-[15px] w-full overflow-hidden flex flex-col justify-start items-start gap-1 p-4'>
        <MacButtons />
